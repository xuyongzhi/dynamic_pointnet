...
__C.TRAIN.EVALUATION_NUM = 700 # 1000

# number of regression parameters,  7 = x,y,l,w, alpha
__C.TRAIN.NUM_REGRESSION = 5

# radius for grouping
__C.TRAIN.Radius_1 = 0.4
__C.TRAIN.Radius_2 = 0.8
__C.TRAIN.Radius_3 = 1.6
__C.TRAIN.Radius_4 = 2.4
__C.TRAIN.Radius_5 = 3.2
...
w=1.6
h=1.7
__C.TRAIN.Anchors = np.array([l, w])
...
__C.TRAIN.Anchor_coordinate_lists = np.array([[[-w/2.0, l/2.0],[w/2.0, l/2.0],[w/2.0, -l/2.0],[-w/2.0, -l/2.0], [-w/2.0, l/2.0]],
...
__C.TRAIN.POSITIVE_THRESHOLD = 0.7

__C.TRAIN.NEGATIVE_THRESHOLD = 0.2
...
# number of 3D anchors
__C.TEST.NUM_ANCHORS = 2

# number of classification
__C.TEST.NUM_CLASS = 2  ## background and vehicle, training from simple situation

# number of regression parameters,  7 = x,y,l,w
__C.TEST.NUM_REGRESSION = 5
