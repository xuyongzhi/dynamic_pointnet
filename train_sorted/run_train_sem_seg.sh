...
python $train_model  --gpu 0    --log_dir log6_4096_xyz1norm  --eval_area 6 --max_epoch 1 --batch_size 1 --num_point 4096  --data_elements xyz_1norm    --all_fn_glob stanford_indoor3d_globalnormedh5_stride_0.5_step_1_4096/*
