...
parser.add_argument('--data_elements',default='xyz_midnorm-color_1norm-xyz_1norm')
...
FLAGS.data_elements = FLAGS.data_elements.split('-')

FLAGS.log_dir = os.path.join(BASE_DIR,'semseg_result/'+FLAGS.log_dir)
...
net_provider = Net_Provider(all_file_list = all_file_list, \
                            ...
                            data_elements = FLAGS.data_elements,\
