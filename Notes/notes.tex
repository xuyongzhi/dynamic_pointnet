...
\begin{tabular}{|p{1.5cm}|p{1.5cm}|p{1cm}|p{2cm}|p{1cm}|p{1.5cm}|p{5cm}| }
	\hline
	\multicolumn{7}{|p{12cm}|}{nh5: 90000\_gs-3d6\_-6d3/ \par bxmh5:  90000\_gs-3d6\_-6d3\_fmn1444-6400\_2400\_320\_32-32\_16\_32\_48-0d1\_0d3\_0d9\_2d7-0d1\_0d2\_0d6\_1d8-pd3-mbf-4A1 \par eval: test } \\
	\hline
	model & bs/bn& lr-decay & elements & norm in sub block & loss weight\par in drop & epoch-pacc-cacc train/eval \\
	\hline
	...
	\multicolumn{7}{|p{12cm}|}{ Conclusion:\par	
		Mid norm in sub block seems worse than no. \par 
		The infuence of input drop seems not obvious. \par 
		Dropout of cnn (0.5) makes the net really hard to train. Seems no good for overfitting. } \\
	\hline
\end{tabular}	
