...
\begin{center}
	...
	\begin{tabular}{|p{1cm} |p{1.5cm} | p{2cm} | p{3.5cm} || p{4cm}|} 
		...
		\hline
		1DSaG & 30/60 & 0.001-40 & 'xyz\_midnorm\_block', 'color\_1norm', 'nxnynz'& 300-0.914-0.775  \\  [0.5ex]
...
\begin{center}
	...
	\begin{tabular}{|p{1cm} |p{1cm} |p{1.5cm} | p{2cm} | p{3.5cm} || p{4cm}|} 
		...
		\hline
		1bG & E & 25/12887\par Y & 0.001\par 40 & xyzmid & 23-0.732-0.326/0.664-0.260\\
		\hline
		1bG & N & 25/12887\par Y & 0.001\par 40 & xyzmid & 25-0.733-0.390/0.666-0.252\\
		\hline
