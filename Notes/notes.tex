...
\subsection{multi scales in 1083}
\begin{tabular}{|p{1.5cm}|p{1.5cm}|p{1cm}|p{3cm}|p{1cm}|p{4cm}| }
	\hline
	...
	\hline
	model & bs/bn& lr-decay & elements & loss weight & epoch-pacc-cacc train/eval \\
	\hline
