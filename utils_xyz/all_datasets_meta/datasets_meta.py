...
class DatasetsMeta():
    ...
    g_less_points_categories['STANFORD_INDOOR3D'] = []
    ...
    g_less_points_categories['SCANNET'] = []
    ...
    g_less_points_categories['KITTI'] = []
