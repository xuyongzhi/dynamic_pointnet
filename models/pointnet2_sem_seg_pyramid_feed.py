...
def placeholder_inputs(batch_size, block_sample,data_num_ele,label_num_ele):
...
def get_model(point_cloud, is_training, num_class, bn_decay=None):
    ...
    block_sample0 = point_cloud.get_shape()[1].value
    block_sample1 = point_cloud.get_shape()[2].value
    end_points = {}
    l0_xyz = point_cloud
    l0_points = None
