...
parser.add_argument('--all_fn_globs', type=str,default='Merged_sph5/128000_gs-6_-10/', help='The file name glob for both training and evaluation')
parser.add_argument('--eval_fnglob_or_rate',  default=0, help='file name str glob or file number rate: scan1*.nh5 0.2')
parser.add_argument('--bxmh5_folder_name', default='Merged_bxmh5/128000_gs-6_-10_fmn4-8000_4800_320_64-24_20_40_32-0d1_0d4_1_2d4-0d1_0d2_0d6_1d2-3B4', help='')
