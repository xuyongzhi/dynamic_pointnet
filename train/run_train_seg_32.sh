...
python train_semseg.py  --gpu 0    --log_dir log6_4096_B32_tmp_xyz1norm  --test_area 6  --max_epoch 10 --batch_size 32 --num_point 4096  --dataset_name scannet --channel_elementes  xyz_1norm


#python train_semseg.py  --gpu 0    --log_dir log6_4096_B8_tmp_xyz1norm  --test_area 6  --max_epoch 10 --batch_size 8 --num_point 4096  --dataset_name stanford_indoor --channel_elementes  xyz_1norm
