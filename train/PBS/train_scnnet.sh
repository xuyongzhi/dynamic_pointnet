...
all_fn_globs='each_house/stride_0d1_step_0d1_pl_nh5_1d6_2/train_0,each_house/stride_0d1_step_0d1_pl_nh5_1d6_2/test'
...
./run_train_seg_presg_scannet.sh 4bG 25 0 $feed_data_elements $all_fn_globs $bxmh5_folder_name $eval_fnglob_or_rate  $multip_feed $finetune $model_epoch $only_evaluate $ShuffleFlag $baselogname $loss_weight
