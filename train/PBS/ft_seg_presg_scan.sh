...
ShuffleFlag='Y'
#ShuffleFlag='N'
baselogname='log-model_5VaG_114-Nlw466-mnc-gsbb_4A1-bs6-lr2-ds_40-Sf_Y-xyz_midnorm_block-color_1norm-90000-sca_1833'
# *****************************************************************************
