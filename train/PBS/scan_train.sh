...
#./run_train_seg_presg_scan.sh 4aG_114 55 0 $feed_data_elements E 0.3   # 0.17G per batch -> 60 for 1080TI, 90 for P100
...
#./run_train_seg_presg_scan.sh 4aG_144 50 0 $feed_data_elements E  1.3  # 0.2G per batch -> 50 for 1080TI, 80 for P100
