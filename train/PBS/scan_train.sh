...
#./run_train_seg_presg_scan.sh 5bG_114 6 1 $feed_data_elements E 1.3   # 0.17G per batch -> 60 for 1080TI, 90 for P100
./run_train_seg_presg_scan.sh 5aG_114 2 0 $feed_data_elements E 1.3   # 0.17G per batch -> 60 for 1080TI, 90 for P100
