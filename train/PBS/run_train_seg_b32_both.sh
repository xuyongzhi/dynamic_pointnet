...
stan_b32_xyz1norm_e50="python $train_script --gpu 0 --test_area 3 --max_epoch 50 --batch_size 32 --num_point 4096  --dataset_name stanford_indoor --channel_elementes xyz_1norm --learning_rate 0.001 --log_dir lograijin"

scannet_b32_xyz1norm_e50="python $train_script --gpu 1 --max_epoch 50 --batch_size 32 --num_point 8192  --dataset_name scannet --channel_elementes xyz_1norm --learning_rate 0.001 --log_dir lograijin"
