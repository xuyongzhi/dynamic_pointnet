...
./run_train_seg_presg_mat.sh 4bG_111 20 0 $feed_data_elements E -> out_mat111.log &
./run_train_seg_presg_mat.sh 4bG_144 18 1 $feed_data_elements E -> out_mat144.log
