...
small_test_xyz1norm="python $train_script --feed_elements xyz_1norm,xyz_midnorm --all_fn_globs stride_1_step_2_test_small_8192_normed/ --eval_fnglob_or_rate 0.4   --max_epoch 3 --batch_size 4  --num_point $numpoint  --dataset_name $dataset_name --log_dir small_data_test_log --auto_break"
$small_test_xyz1norm
